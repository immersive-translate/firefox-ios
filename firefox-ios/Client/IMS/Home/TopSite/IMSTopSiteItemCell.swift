...
class IMSTopSiteItemCell: UICollectionViewCell, ReusableCell {
    // MARK: - Variables
    ...
    func configure(_ topSite: TopSite,
        ...
        if let imageResource: SiteResource = topSite.site.faviconResource {
...
extension IMSTopSiteItemCell: ThemeApplicable {
...
// MARK: - Blurrable
extension IMSTopSiteItemCell: Blurrable {
