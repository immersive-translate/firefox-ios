...
class IMSTopSitesViewModel {
    ...
    init(profile: Profile,
        ...
        self.topSites = IMSAppManager.shared.topSiteService.getTopSites()
...
extension IMSTopSitesViewModel: HomepageViewModelProtocol, FeatureFlaggable {
...
extension IMSTopSitesViewModel: TopSitesManagerDelegate {
    func didLoadNewData() {
        ensureMainThread {
...
extension IMSTopSitesViewModel: HomepageSectionHandler {
    func configure(_ collectionView: UICollectionView,
                   at indexPath: IndexPath) -> UICollectionViewCell {
        if let contentItem = topSites[safe: indexPath.row],
           let cell = collectionView.dequeueReusableCell(cellType: IMSTopSiteItemCell.self, for: indexPath) {
