...
class IMSAPPTopSiteService {
    ...
    init() {
        topSites = [
            ...
            .init(site: .init(id: 4, url: "https://browser.immersivetranslate.com/manga", title: .ImtLocalizableComicTranslation, bookmarked: false, faviconResource: .bundleAsset(name: "image_intro", forRemoteResource: Bundle.main.bundleURL))),
            .init(site: .init(id: 5, url: "https://browser.immersivetranslate.com/image", title: "Imt.Localizable.Image.Translation".i18nImt(), bookmarked: false, faviconResource: .bundleAsset(name: "cartoon-intro", forRemoteResource: Bundle.main.bundleURL))),
