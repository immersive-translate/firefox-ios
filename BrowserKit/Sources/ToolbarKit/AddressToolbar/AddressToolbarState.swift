...
public struct AddressToolbarState {
    ...
    public let locationViewState: LocationViewState

    /// Navigation actions of the address toolbar
    public let navigationActions: [ToolbarElement]

    /// Page actions of the address toolbar
    public let pageActions: [ToolbarElement]

    /// Browser actions of the address toolbar
    public let browserActions: [ToolbarElement]

    /// The position of the toolbar border to be displayed
    public let borderPosition: AddressToolbarBorderPosition?
